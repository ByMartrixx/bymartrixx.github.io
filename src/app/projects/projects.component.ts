...
export class ProjectsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.jsonp('https://api.github.com/users/ByMartrixx/repos', 'callback')
  ...
  private handleError(error: HttpErrorResponse) {
    if (error.error instanceof ErrorEvent) {
      ...
      console.error(`Github API returned code ${error.status}, ` + `message was: ${error.error.message}`)
    }
